Shader "Custom/Grass_PBR"
{
    Properties
    {
        _FootColor ("Base Color", Color) = (0.0, 0.15, 0.0, 1.0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes IN)
            {
                ...
                normalInputs.normalWS = float3(0.0, 1.0, 0.0);
                // normalInputs.normalWS = mul(float3(0.0, 1.0, 0.0), finalMatrix);
                // normalInputs.normalWS = normalInputs.normalWS;
                // normalInputs.normalWS = mul(normalInputs.normalWS, finalMatrix);
                // normalInputs.tangentWS = mul(normalInputs.tangentWS, finalMatrix);
                // normalInputs.bitangentWS = mul(normalInputs.bitangentWS, finalMatrix);
                ...
                half3 vertexLight = VertexLighting(positionWS, normalInputs.normalWS); // TODO: Transform normals too
